...
class TradeSettingWidget extends StatefulWidget {
   static const id = 'TradeSettingWidget';
  @override
  _TradeSettingWidgetState createState() => _TradeSettingWidgetState();
}

class _TradeSettingWidgetState extends State<TradeSettingWidget> {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 8,),
                            Text( "Quick Trading For Pro Traders ",
                              style: TextStyle(color: Theme
                                  .of(context)
                                  .indicatorColor,
                                fontSize: 8,
